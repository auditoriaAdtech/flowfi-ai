...
const CURRENCIES = [
  ...
  { value: 'DOP', label: 'DOP - Dominican Peso (RD$)' },
  { value: 'CUP', label: 'CUP - Cuban Peso (\u20b1)' },
  { value: 'JMD', label: 'JMD - Jamaican Dollar (J$)' },
  { value: 'TTD', label: 'TTD - Trinidad & Tobago Dollar (TT$)' },
  { value: 'BZD', label: 'BZD - Belize Dollar (BZ$)' },
  { value: 'SRD', label: 'SRD - Surinamese Dollar (SRD)' },
  { value: 'GYD', label: 'GYD - Guyanese Dollar (G$)' },
  { value: 'HTG', label: 'HTG - Haitian Gourde (G)' },
  { value: 'BSD', label: 'BSD - Bahamian Dollar (B$)' },
  { value: 'BBD', label: 'BBD - Barbadian Dollar (BBD$)' },
  { value: 'XCD', label: 'XCD - East Caribbean Dollar (EC$)' },
  { value: 'AWG', label: 'AWG - Aruban Florin (Afl.)' },
  { value: 'ANG', label: 'ANG - Netherlands Antillean Guilder (NAf.)' },
  { value: 'KYD', label: 'KYD - Cayman Islands Dollar (CI$)' },
  { value: 'BMD', label: 'BMD - Bermudian Dollar (BD$)' },
  { value: 'FKP', label: 'FKP - Falkland Islands Pound (FK\u00a3)' },
];
